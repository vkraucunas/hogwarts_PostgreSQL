...
--     mascot text,
--     colours text,
--     house_head_id integer references teachers(id)
-- );
...
--     'Can\'t Believe It\'s Not Magic: Wifi and Other Muggle Tech', (SELECT id FROM subjects WHERE name = 'Muggle Studies'), (SELECT id FROM professors WHERE name = 'Charity Burbage')
...
-- 'Dr. Mac McDermott', (SELECT id FROM houses WHERE name = 'Gryffindor'), 2, 'gnu'
...
-- 'Kaci Rempel', (SELECT id FROM houses WHERE name = 'HufflePuff'), 6, 'kangaroo'
...
-- 'Raina Marks', (SELECT id FROM houses WHERE name = 'HufflePuff'), 5, 'iguana'
...
-- 'Jessyca Breitenberg', (SELECT id FROM houses WHERE name = 'HufflePuff'), 5, 'fish'
...
-- 'Markus Maggie', (SELECT id FROM houses WHERE name = 'HufflePuff'), 3, 'coati'
...
-- 'Antonette Lueilwitz', (SELECT id FROM houses WHERE name = 'Ravenclaw'), 2, 'beaver'
